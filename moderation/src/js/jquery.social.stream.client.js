...
(function($){
	...
	function nicetime(a,out,dates){
		...
		function share(st,sq,twitterId,status, index, hasNotes, scheduled){
			...
			/*s += '<div class="" data-toggle="buttons"><label class="btn btn-block btn-sm btn-flat btn-success active"><input hidden type="radio" name="options" id="option1" autocomplete="off" ><i class="fa-solid fa-plus"></i> Approve Post</label><label class="btn btn-block btn-sm btn-flat btn-warning"><input hidden type="radio" name="options" id="option2" autocomplete="off" checked><i class="fa-solid fa-check"></i> Post Aprroved</label></div>';*/
			
			if(status=='yes')
			{
				s += '<div class="actions"><label class="btn btn-block btn-sm btn-flat btn-warning" onclick="approvePost(this, '+index+')" data-approved="yes"><i class="fa-solid fa-check"></i> APPROVED</label></div>';	
			}
			else
			{
				s += '<div class="actions"><label class="btn btn-block btn-sm btn-flat btn-success" onclick="approvePost(this, '+index+')" data-approved="no"><i class="fa-solid fa-plus"></i> APPROVE</label></div>';
			}
						
			s += '<a style="background: #343a40;padding-right:10px;padding-left:5px;padding-top:7px;padding-bottom:25px" class="share-linkedin editPost" href="javascript:;"><i class="fa-solid fa-plus"></i> EDIT</a>';
