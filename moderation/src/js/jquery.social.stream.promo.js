...
(function($){
	...
	function nicetime(a,out,dates){
		...
		function share(st,sq,twitterId,status, index, hasNotes, scheduled){
			...
			s = '<div class="btn btn-block btn-sm btn-flat btn-danger mb-2"><i class="fa-solid fa-arrow-down"></i> <small>SHARE TWICE TO CLAIM</small> <i class="fa-solid fa-arrow-down"></i> </div>';
