...
(function($){
			...
			success: function(a){
				...
				if(error == ''){
					$.each(a, function(i,item){
						if(i < n){
							var html = [], q = item.link, u='<a href="'+href+'" class="link-user">'+id+'</a>', w='', x = '<a href="'+q+'" data-date="'+item.publishedDate+'" data-id="'+item.id+'">'+item.title+'</a>', y='', z='', zz='', m='', d = item.publishedDate, sq = q, st = item.title, s = '';
							switch(type)
							{
								case 'facebook':
									x = '';
								...
								z = item.text;
								var src = item.image;
								y = src ? '<a data-image_count='+i+' href="'+q+'"><img src="'+src+'" alt="" /></a>' : '' ;
								break;
							...
							var out = '<li rel="'+ob+'" class="dcsns-li dcsns-'+type+' dcsns-feed-'+fn+'" data-index="'+i+'">'+w+'<div class="inner">'+zz+'<span class="clear"></span></div>'+zintro+icon+'</li>', str = decodeURIComponent(opt.remove), rem = q;
							if(type == 'twitter'){
	...
	function nicetime(a,out,dates){
		...
		function share(st,sq,twitterId){
			...
			s = '<a href="https://www.facebook.com/sharer.php?u='+sq+'&t='+st+'" class="share-facebook" target="_blank"><i class="fab fa-facebook-f"></i></a>';
			s += '<a href="https://www.linkedin.com/shareArticle?mini=true&url='+sq+'&title='+st+'" class="share-linkedin" target="_blank"><i class="fab fa-linkedin-in"></i></a>';
			//s += '<a href="http://pinterest.com/pin/create/button/?url='+sq+'&media={$meta_image}&description='+st+'" class="share-pinterest" target="_blank"><i class="fab fa-pinterest"></i></a>';
            s += '<a href="https://pinterest.com/pin/create/button/?url='+sq+'&media='+sq+'&description='+st+'" class="share-pinterest" target="_blank"><i class="fab fa-pinterest"></i></a>';
            s += '<a href="https://reddit.com/submit?url='+sq+'&title='+st+'" class="share-reddit" target="_blank"><i class="fab fa-reddit"></i></a>';
            s += '<a href="https://web.skype.com/share?url='+sq+'&text='+sq+'" class="share-skype" target="_blank"><i class="fab fa-skype"></i></a>';
            s += '<a href="https://t.me/share/url?url='+sq+'&text='+st+'" class="share-telegram" target="_blank"><i class="fab fa-telegram"></i></a>';
            s += '<a href="https://www.tumblr.com/widgets/share/tool?canonicalUrl='+sq+'&title='+st+'&caption='+sq+'" class="share-tumblr" target="_blank"><i class="fab fa-tumblr"></i></a>';
            s += '<a href="https://twitter.com/share?url='+sq+'&text='+st+'&via='+twitterId+'" class="share-twitter" target="_blank"><i class="fab fa-twitter"></i></a>';
			s += '<a href="https://api.whatsapp.com/send?text='+sq+'" class="share-whatsapp" target="_blank"><i class="fab fa-whatsapp"></i></a>';
            s += '<a href="https://suite.social/share/instagram/index.php?p='+sq+'" class="share-instagram" target="_blank"><i class="fab fa-instagram"></i></a>';						
			/*s += '<a href="https://www.xing.com/spi/shares/new?url='+sq+'" class="share-xing" target="_blank"><i class="fab fa-xing"></i></a>';	
			s += '<a href="https://www.blogger.com/blog-this.g?u='+sq+'&n='+st+'&t='+sq+'" class="share-blogger" target="_blank"><i class="fab fa-blogger"></i></a>'; 
			s += '<a href="https://share.flipboard.com/bookmarklet/popout?v=2&title='+st+'&url='+sq+'" class="share-flipboard" target="_blank"><i class="fab fa-flipboard"></i></a>';
			s += '<a href="https://mail.google.com/mail/?view=cm&to={email_address}&su='+st+'&body='+sq+'" class="share-google" target="_blank"><i class="fab fa-google"></i></a>';
			s += '<a href="http://www.livejournal.com/update.bml?subject='+st+'&event='+sq+'" class="share-livejournal" target="_blank"><i class="fab fa-livejournal"></i></a>';
