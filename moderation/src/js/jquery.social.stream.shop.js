...
(function($){
	...
	function nicetime(a,out,dates){
		...
		function share(st,sq,twitterId){
			...
			s += '<a style="background: #343a40;padding-right:10px;padding-left:5px;padding-top:7px;padding-bottom:25px" href="javascript:;"><i class="fa-solid fa-basket-shopping"></i> PURCHASE</a>';								
			return s;
        }
})(jQuery);
