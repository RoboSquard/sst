        ...
        <div class="row">
		  ...
		  Social Media Moderation</p>
            ...
            <div class="card card-primary card-outline">
              ...
              <div style="padding: 0rem;" class="card-body text-center">
			  <p>Click "APPROVE" to publish or "EDIT" to change content. Click trash icon to delete. Post approved are published in that order. Approve first then select bonus to view published posts.</p>
...
<?php require_once 'carousel.php'; ?>
            ...
            <div class="card card-primary card-outline">
              <!--<div class="card-header text-center">
				<p>Click "APPROVE" to publish. Click "EDIT" to change content. Click trash icon to delete. Each post approved or scheduled is published in that order. Select bonus above to view published posts.</p>							
              </div>-->		
