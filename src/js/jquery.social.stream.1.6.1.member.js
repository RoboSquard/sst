...
(function($){
	...
	function nicetime(a,out,dates){
		...
		function share(st,sq,twitterId, item = {}){
			...
			//s += '<a href="https://mix.com/add?url='+sq+'" class="share-mix"><i class="fab fa-mix"></i></a>';
			//s += '<a href="mailto:subject=Check+out+this+url&body='+sq+'" class="share-email"><i class="fab fa-envelope"></i></a>';
			//s += '<a href="http://vk.com/share.php?url='+sq+'&title='+st+'&comment='+sq+'" class="share-vk"><i class="fab fa-vk"></i></a>';
			//s += '<a href="http://compose.mail.yahoo.com/?to={email_address}&subject='+st+'&body='+sq+'" class="share-yahoo"><i class="fab fa-yahoo"></i></a>';							
			return s;
        }
