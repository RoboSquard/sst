/*
 * Social Stream
 * Copyright (c) 2021 ssur.uk
 * https://ssur.uk
 * Version 1.6.2 (18-02-2021)
 *
 */
...
(function($){
	...
	function nicetime(a,out,dates){
		...
		function share(st,sq,twitterId){
			...
			s = '<a style="color:#5b8dcd" href="https://www.facebook.com/sharer.php?u='+sq+'&t='+st+'" class="share-facebook" target="_blank"><i class="fab fa-facebook-square"></i></a>';
			s += '<a style="color:#52d6f7" href="https://twitter.com/share?url='+sq+'&text='+st+'&via='+twitterId+'" class="share-twitter" target="_blank"><i class="fab fa-twitter-square"></i></a>';
			//s += '<a style="color:#cb2027" href="https://pinterest.com/pin/create/button/?url='+sq+'&media='+sq+'&description='+st+'" class="share-pinterest" target="_blank"><i class="fab fa-pinterest"></i></a>';
			s += '<a style="color:#00e024" href="https://api.whatsapp.com/send?text='+sq+'" class="share-whatsapp" target="_blank"><i class="fab fa-whatsapp"></i></a>';
			s += '<a style="color:#00a5d5" href="https://www.linkedin.com/shareArticle?mini=true&url='+sq+'&title='+st+'" class="share-linkedin" target="_blank"><i class="fab fa-linkedin"></i></a>';
			return s;
        }
})(jQuery);
